# https://docs.agno.com/examples/getting-started/agent-with-storage
...
OLLAMA_EMBEDDER_MODEL_NAME = os.getenv("OLLAMA_EMBEDDER_MODEL_NAME", "mxbai-embed-large")
...
agent_knowledge = PDFUrlKnowledgeBase(
    ...
    vector_db=LanceDb(
        ...
        embedder=OllamaEmbedder(id=OLLAMA_EMBEDDER_MODEL_NAME, host=OLLAMA_HOST)
    ),
)
